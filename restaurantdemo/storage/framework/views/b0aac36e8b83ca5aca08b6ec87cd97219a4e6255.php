...
<div class="col-xs-12"  id="no-more-tables">
    ...
    <table id="users" class="table table-hover table-condensed table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <tbody>
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td><?php echo e(++$i); ?></td>
                <td><?php echo e($menu->category_name); ?></td>
                <?php  
                $menuId = encrypt($menu->menuId);
                 ?>
                <td><?php echo e($menu->description); ?></td>
                <td><img src="<?php echo e($menu->image_url); ?>" width="150"></td>
                <td><p class="label label-success">Status</p></td>
                <td><a href="<?php echo e(url('/manageCategories/edit/'.$menuId)); ?>" class="btn btn-primary">Edit</a></td>
                <td><a data-toggle="modal" data-target="#deleteModel" class="btn btn-danger" data-whatever="<?php echo e($menu->menuId); ?>" class="btn btn-danger">Delete</a></td>
            </tr>
...
<div id="addmenu" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        <form method="post" action="<?php echo e(url('/manageCategories/add')); ?>" enctype="multipart/form-data">
...
<div class="modal fade" id="deleteModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" action="<?php echo e(url('/manageCategories/delete')); ?>">
                <?php echo e(csrf_field()); ?>
