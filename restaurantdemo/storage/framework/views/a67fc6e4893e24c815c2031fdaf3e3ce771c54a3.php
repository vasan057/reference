    ...
    <table id="users" class="table table-hover display table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <label><?php echo e($customer->customerAddrCount); ?></label>
                </td>
                <td>
                    <label><?php echo e($customer->customerCartCount1); ?></label>
                </td>
                <td>
                    <label>0</label>
                </td>
                <td>
                    <a href="<?php echo e(url('/manageCustomers/edit/'.$customerId)); ?>" class="btn btn-danger">Edit</a>
                </td>
                <td>
                    <a class="btn btn-danger" data-toggle="modal" data-target="#deleteModel" class="btn btn-danger" data-whatever="<?php echo e($customer->id); ?>">Delete</a>
                </td>
            </tr>
...
<div id="addcustomer" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <form method="post" action="<?php echo e(url('/manageCustomers/add')); ?>" enctype="multipart/form-data">
...
<div id="resetpwd" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <form method="post" action="<?php echo e(url('/manageCustomers/resetPassword')); ?>">
            <?php echo e(csrf_field()); ?>
...
<div class="modal fade" id="deleteModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" action="<?php echo e(url('/manageCustomers/delete')); ?>">
                <?php echo e(csrf_field()); ?>
