...
<div class="col-xs-12" id="no-more-tables">
    ...
    <table id="users" class="table table-hover table-condensed table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <tbody>
            <?php $__currentLoopData = $image_reference; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $imgRef): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td><?php echo e(++$i); ?></td>
                <td><img src="<?php echo e(url($imgRef->image_url)); ?>" width="150" class="img-responsive"/></td>
                <td><?php echo e($imgRef->image_desc); ?></td>
                <td><p class="label label-success">Status</p></td>
                <td><a data-toggle="modal" data-target="#deleteModel" class="btn btn-danger" data-whatever="<?php echo e($imgRef->id); ?>" class="btn btn-danger">Delete</a></td>
            </tr>
...
<div id="addimgreference" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <form method="post" action="<?php echo e(url('/manageImagereference/add')); ?>" enctype="multipart/form-data">
...
<div class="modal fade" id="deleteModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" action="<?php echo e(url('/manageImagereference/delete')); ?>">
                <?php echo e(csrf_field()); ?>
