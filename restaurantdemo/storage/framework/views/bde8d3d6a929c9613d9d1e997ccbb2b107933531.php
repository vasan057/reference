<div class="panel-body row" id="product_container">
    <div id="myTabContent" class="tab-content">
        ...
        <div class="tab-pane fade" id="documents">
            <div  class="card">
                <input type='text' id='txt_manageImg' value='' name="txt_manageImg" />
                <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $imgs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-12 file-select">
                        <div class="col-md-2"><input class="select-img" type="checkbox" value="<?php echo e($imgs->image_url); ?>"> </div>
                        <div class="col-md-4">
                            <img src="<?php echo e($imgs->image_url); ?>" alt=""/></div>
                        <div class="col-md-4"><?php echo e($imgs->image_desc); ?></div>
                    </div>
