            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul id="active" class="nav navbar-nav side-nav">
                        ...
                        <li class="dropdown"><a class="dropdown dropdown-toggle" data-toggle="dropdown"><i class="fa fa-users"></i> Manage Restaurants <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo e(url('/manageRestaurents')); ?>"><i class="fa fa-users"></i> My Restaurants</a></li>
                                <li><a href="<?php echo e(url('/manageCategories')); ?>"><i class="fa fa-list"></i> My Menu Categories</a></li>
                                <li><a href="<?php echo e(url('/manageMenuItems')); ?>"><i class="fa fa-list"></i> My Menu Items</a></li>
                                <li><a href="<?php echo e(url('/manageMenu')); ?>"><i class="fa fa-list-ol"></i> My Menus</a></li>
                                <li><a href="<?php echo e(url('/manageDiningtable')); ?>"><i class="fa fa-users"></i> Dining Table</a></li>
                            </ul>
                        </li>
                        <li class="dropdown"><a class="dropdown dropdown-toggle" data-toggle="dropdown"><i class="fa fa-users"></i> Manage Orders <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo e(url('/manageOrders')); ?>"><i class="fa fa-list"></i> My Orders</a></li>
                                <li><a href="<?php echo e(url('/deliveryTracks')); ?>"><i class="fa fa-users"></i> Delivery</a></li>
                                <li><a href="<?php echo e(url('/manageDiningtabletracks')); ?>"><i class="fa fa-users"></i> Dining Table Tracks</a></li>
                                <li><a href="<?php echo e(url('/manageBilling')); ?>"><i class="fa fa-users"></i> Billing</a></li>
                                <li><a href="<?php echo e(url('/manageReservation')); ?>"><i class="fa fa-users"></i> Reservation</a></li>
                            </ul>
                        </li>
                        
                        <li class="dropdown"><a class="dropdown dropdown-toggle" data-toggle="dropdown"><i class="fa fa-users"></i> Manage Settings <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo e(url('/managePositions')); ?>"><i class="fa fa-users"></i> Positions</a></li>
                                <li><a href="<?php echo e(url('/manageMasterCity')); ?>"><i class="fa fa-users"></i> Manage Master City</a></li>
                                <li><a href="<?php echo e(url('/manageMasterState')); ?>"><i class="fa fa-users"></i> Manage Master State</a></li>
                                <li><a href="<?php echo e(url('/manageMasterCountry')); ?>"><i class="fa fa-users"></i> Manage Master Country</a></li>
                            </ul>
                        </li>
                        ...
                        <li><a href="<?php echo e(url('/manageCarts')); ?>"><i class="fa fa-users"></i> Manage Carts</a></li>
                        <li><a href="<?php echo e(url('/manageCartsdetails')); ?>"><i class="fa fa-users"></i> Carts Details</a></li>
                        <li><a href="<?php echo e(url('/manageSection')); ?>"><i class="fa fa-users"></i> Manage Section</a></li>
                        ...
                        <li><a href="<?php echo e(url('/managePasswordreset')); ?>"><i class="fa fa-users"></i> Password Reset</a></li>
